...
local function patchCoverBrowser(plugin)
    ...
    function MosaicMenuItem:update(...)
        ...
        if self.entry.is_file or self.entry.file or not self.mandatory then
            return
        end -- it's a file
            ...
            nbitems_widget = BottomContainer:new({
                ...
                RightContainer:new({
                    ...
                    FrameContainer:new({
                        ...
                        background = Blitbuffer.colorFromString(G_reader_settings:readSetting("ui_background_color_hex", "#ffffff")),
