...
local function patchCoverBrowser(plugin)
    ...
    function MosaicMenuItem:_setFolderCover(img)
        ...
        if item_count > 0 then
            local nbitems = TextWidget:new {
                ...
                bold = true, padding = 0,
                fgcolor = Blitbuffer.colorFromString(G_reader_settings:readSetting("ui_font_color_hex", "#000000")),
            }
            ...
            nbitems_widget = BottomContainer:new {
                ...
                RightContainer:new {
                    ...
                    FrameContainer:new {
                        ...
                        radius = math.ceil(nb_size), background = Blitbuffer.colorFromString(G_reader_settings:readSetting("ui_background_color_hex", "#ffffff")),
    ...
    function MosaicMenuItem:paintTo(bb, x, y)
        ...
        local ix, iy, iw, ih = image_x, image_y, image_size.w, image_size.h
        bb:paintRect(ix, iy, iw, cover_border, Blitbuffer.COLOR_BLACK)
        bb:paintRect(ix, iy, cover_border, ih, Blitbuffer.COLOR_BLACK)
        bb:paintRect(ix + iw - cover_border, iy, cover_border, ih, Blitbuffer.COLOR_BLACK)
