    ...
    function MosaicMenuItem:paintTo(bb, x, y)
        ...
        if target and target.dimen then
            ...
            if not self.is_directory then
                local corner_radius = math.floor((_corner_w or 0) * 0.4)
                ...
                bb:paintRect(ix + corner_radius, iy + ih - cover_border, iw - 2 * corner_radius, cover_border, Blitbuffer.COLOR_BLACK)
            end
        end
