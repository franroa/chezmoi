...
cp -r /home/froa/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/home/froa/.config/opencode/context/` to follow your coding standards.
...
nano ~//home/froa/.config/opencode/context/project/project-context.md
...
A: Edit `~//home/froa/.config/opencode/context/project/project-context.md` - agents automatically load this file.
