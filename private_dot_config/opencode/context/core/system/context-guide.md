...
**Index Location**: `/home/froa/.config/opencode/context/index.md` - Quick map of all contexts
...
**Central Index**: `/home/froa/.config/opencode/context/index.md` - Ultra-compact map of all contexts
...
All files are in `/home/froa/.config/opencode/context/core/` with organized subfolders:
...
- Load `/home/froa/.config/opencode/context/index.md`
...
### /home/froa/.config/opencode/context/core/standards/code.md
- Writing new code
- Modifying existing code
- Following modular/functional patterns
- Making architectural decisions

### /home/froa/.config/opencode/context/core/standards/docs.md
- Writing README files
- Creating API documentation
- Adding code comments

### /home/froa/.config/opencode/context/core/standards/tests.md
- Writing new tests
- Running test suites
- Debugging test failures

### /home/froa/.config/opencode/context/core/standards/patterns.md
- Error handling
- Security patterns
- Common code patterns

### /home/froa/.config/opencode/context/core/standards/analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /home/froa/.config/opencode/context/core/workflows/delegation.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /home/froa/.config/opencode/context/core/workflows/task-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /home/froa/.config/opencode/context/core/workflows/sessions.md
- Session lifecycle
- Cleanup procedures
- Session isolation

### /home/froa/.config/opencode/context/core/workflows/review.md
- Reviewing code
