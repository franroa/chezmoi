-- https://www.reddit.com/r/neovim/comments/1gvqiol/thnks_fr_th_trsttr_tiny_text_editing_automations/
local M = {}
...
function M.add_async()
  ...
  local function_node = require("functions.treesitter_utils").find_node_ancestor(
