...
---@param cb any
function M.has_worktree(path_str, branch, root, cb)
    local found = false
    local path
...
---@param root string
---@param cb function
function M.has_branch(branch, opts, root, cb)
    local found = false
...
--- @param root string
--- @return Job
function M.create_worktree_job(path, branch, found_branch, upstream, found_upstream, root)
...
--- @param root string
--- @return Job
function M.delete_worktree_job(path, force, root)
