  ...
  return function(spec)
    ...
    data_accum:subscribe(function(data)
     ...
     local result_code
      ...
      local additional_args = spec.context.dotnet_additional_args or {}
      -- Add run_opts additional_args if available
      if spec.context.run_opts and spec.context.run_opts.additional_args then
        additional_args = vim.list_extend(additional_args, spec.context.run_opts.additional_args)
      end
      local run_result = client:debug_tests(ids, additional_args)
