...
---@field private run_opts RunOpts
local dotnet_utils = { opts = {}, run_opts = {} }
...
---@param opts RunOpts
function dotnet_utils.add_run_opts(opts)
  dotnet_utils.run_opts = vim.tbl_extend("force", dotnet_utils.run_opts, opts)
end

---@return RunOpts
function dotnet_utils.get_run_opts()
  return dotnet_utils.run_opts
end
