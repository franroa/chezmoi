...
---@field run_tests fun(self: neotest-vstest.Client, ids: string|string[], additional_args?: string[]): neotest-vstest.Client.RunResult
---@field debug_tests fun(self: neotest-vstest.Client, ids: string|string[], additional_args?: string[]): neotest-vstest.Client.DebugResult
