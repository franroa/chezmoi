...
local function create_adapter(config)
  ...
  dotnet_utils.add_run_opts(config.run_opts or {})
  ...
  function DotnetNeotestAdapter.discover_positions(path)
   ...
   function DotnetNeotestAdapter.build_spec(args)
      ...
      -- Extract additional arguments from args (passed at runtime)
      local dotnet_additional_args = args.dotnet_additional_args or args.additional_args or {}
      
      -- Get run_opts from dotnet_utils
      local run_opts = dotnet_utils.get_run_opts()
      ...
      return {
        context = {
          ...
          dotnet_additional_args = dotnet_additional_args,
          run_opts = run_opts,
        },
        stream = function()
          return function()
