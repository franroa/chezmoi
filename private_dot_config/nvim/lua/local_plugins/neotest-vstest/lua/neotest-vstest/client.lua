...
function TestClient:run_tests(ids, additional_args)
   return self.sub_client:run_tests(ids, additional_args)
end

function TestClient:debug_tests(ids, additional_args)
   return self.sub_client:debug_tests(ids, additional_args)
end
