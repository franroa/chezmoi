...
---@param additional_args? string[] additional arguments (will be passed as environment variables prefixed with TESTING_)
---@return neotest-vstest.Client.RunResult
function M.run_tests(dll_path, nodes, additional_args)
  local run_results = {}
...
function M.debug_tests(dll_path, nodes, additional_args)
  local mtp_env = {
