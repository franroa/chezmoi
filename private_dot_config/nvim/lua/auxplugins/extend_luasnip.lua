...
--       vim.g.snips_author = "francisco"
--       vim.g.snips_email = "franciscoroaprieto@gmailcom"
--       vim.g.snips_github = "https://github.com/franroa"
--       vim.g.snips_company = "franroa"
--
--       -- Mandatory setup function
--       require("luasnip_snippets.common.snip_utils").setup()
--     end,
