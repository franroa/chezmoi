...
function theme.at_screen_connect(s)
	...
	local names = { "1-WEB", "2-PROG", "3-GPT", "4-SYNAOS", "5-TEAMS", "6-OBS", "7-FILES", "8-SLACK", "9-MIS" }
	...
	s.myverticalwibox =
		awful.wibar({ position = "left", screen = s, width = 142, bg = theme.bg_normal, fg = theme.fg_normal })

	-- if awful.screen.focused().workarea.height > 960 then -- TODO: to be done
	local mylauncher = awful.widget.button({ image = theme.awesome_icon })
	-- else
	-- local mylauncher = awful.widget.button({ image = "" })
	-- end
	...
	s.myverticalwibox.visible = false
end
