...
local gpmdp = require("widgets.gpmdp") -- TODO: mdp
-- }}}
...
awful.screen.connect_for_each_screen(function(s)
  --  local adjust = 10
  -- s.padding = {
  -- 	left = s.padding.left + adjust,
  -- 	right = s.padding.right + adjust,
  -- 	top = s.padding.top + adjust,
  -- 	bottom = s.padding.bottom + adjust,
  -- }
...
-- User Hotkeys
  awful.key({ altkey }, "x", function()
    awful.util.spawn("pkill mpv")
  end),
  awful.key({ altkey }, "x", function()
    awful.util.spawn("pkill youtube-viewer")
  end),
  ...
  awful.key({ altkey, "Control" }, "Up", function()
    awful.spawn.with_shell("mpc toggle") -- TODO: mpc check
  ...
  awful.key({ altkey }, "0", function() --TODO: check MPD
...
awful.rules.rules = {
  ...
  {
    rule = { class = "Brave" },
    properties = { tag = awful.screen.focused().tags[1], switchtotag = true },
  },
  -- { rule = { class = "scraping" },                   properties = { tag = awful.screen.focused().tags[1], switchtotag = true } },
  {
    rule = { class = "Xfce4-terminal" },
    properties = { tag = awful.screen.focused().tags[2], switchtotag = true },
  },
  {
    rule = { class = "Google" },
    properties = { tag = awful.screen.focused().tags[3], switchtotag = true },
  },
  {
    rule = { class = "firefox" },
  ...
  {
    rule = { class = "Opera" },
    properties = { tag = awful.screen.focused().tags[5], switchtotag = true },
  },
  {
    rule = { class = "obsidian" },
    properties = { tag = awful.screen.focused().tags[6], switchtotag = true },
  },
  {
    rule = { class = "Thunar" },
    properties = { tag = awful.screen.focused().tags[7], switchtotag = true },
  },
  {
    rule = { class = "Slack" },
    properties = { tag = awful.screen.focused().tags[8], switchtotag = true },
  },
